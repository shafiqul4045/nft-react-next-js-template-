...
function DiscoverAuctionWrapper() {
  const customStyles = {
  ...
  return (
    <>
      <div className="discover-page-area mt-100">
                      ...
                      <span>
                        <img
                          src={
                            ...
                            "/images/discover/discover-title-icon.png"
                          }
                  ...
                  <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                    <div className="title-category text-end">
                      <div className="title-category-btn-wrap auction-title-category-btn-wrap">
                        <div className=" filter-options discover-auction title-category-select">
                          <Select
                        ...
                        <div className="custom-select discover-auction filter-options title-category-select">
                          <Select
                  ...
                  <div className="discover-category-box">
                    ...
                    <div className="single-category-box">
                      ...
                      <div className="price-range-slider">
                        <PriceRange color="#ffae01" width="300"/>
                      </div>
                    </div>
        ...
        <img
          className="shape discover-auction-shape"
          src={
            process.env.PUBLIC_URL +
            "/images/auction/discover-auction-page-shape.png"
          }
          alt="images"
        />
      </div>
...
const CatagodyBTN = () => {
  ...
  return (
    <>
      ...
      <div className="row g-4 mt-50" id="MixItUpC15DB7">
        {items.map((element) => {
                ...
                <div className="discover-content">
                  ...
                  <div className="discover-owner">
                    <ul>
                      <li>
                        <div>
                          <span key={element.id}>Owner:</span> {name}
                        </div>
...
export default DiscoverAuctionWrapper;
